...
'/Users/julie/github/nupic/build/release/lib/python2.7/site-packages/nupic/frameworks/opf/exp_generator/ExpGenerator.pyc'
"""
...
permutations = {
  ...
  'modelParams': {
      'inferenceType': PermuteChoices(['TemporalMultiStep']),
  ...
  u'tld': PermuteEncoder(fieldName='tld', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'subdomain': PermuteEncoder(fieldName='subdomain', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'hostname': PermuteEncoder(fieldName='hostname', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path1': PermuteEncoder(fieldName='path1', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path2': PermuteEncoder(fieldName='path2', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path3': PermuteEncoder(fieldName='path3', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path4': PermuteEncoder(fieldName='path4', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path5': PermuteEncoder(fieldName='path5', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  u'path6': PermuteEncoder(fieldName='path6', encoderClass='SDRCategoryEncoder', w=21, n=121, ),
  '_classifierInput': dict(classifierOnly=True, n=121, fieldname='hostname', w=21, type='SDRCategoryEncoder', ),
      },
    },
...
#       report generator
# (generated from minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1, 3\]:window=1000:field=hostname")
minimize = "multiStepBestPredictions:multiStep:errorMetric='avg_err':steps=\[1, 3\]:window=1000:field=hostname"
