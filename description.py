...
config = {
  ...
  u'timestamp_weekend':     {   'fieldname': u'timestamp',
    ...
    'type': 'DateEncoder',
    'weekend': 21},
  u'tld':     {   'fieldname': u'tld',
    'n': 121,
    'name': u'tld',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'subdomain':     {   'fieldname': u'subdomain',
    'n': 121,
    'name': u'subdomain',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  u'hostname':     {   'fieldname': u'hostname',
    'n': 121,
    'name': u'hostname',
    'type': 'SDRCategoryEncoder',
    'w': 21},
  '_classifierInput':     {   'classifierOnly': True,
    'fieldname': u'hostname',
    'n': 121,
...
control = {
 ...
 u'predictedField': u'hostname',
 u'predictionSteps': [1, 3]},

  # Metrics: A list of MetricSpecs that instantiate the metrics that are
  # computed for this experiment
  'metrics':[
    MetricSpec(field=u'hostname', metric='multiStep', inferenceElement='multiStepBestPredictions', params={'window': 1000, 'steps': [1, 3], 'errorMetric': 'avg_err'})
  ],
